      ...
      <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        >
          {/* 
             ...
             Updated styles: 'h-10 w-auto object-contain'
             This ensures the logo keeps its natural shape (square, wide, or tall)
             and fits within the header height without being cropped or distorted.
          */}
          <img 
            src="/images/1.png" 
